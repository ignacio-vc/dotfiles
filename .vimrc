...
" Spaces Only
au FileType swift,mustache,markdown,cpp,hpp,vim,sh,html,htmldjango,css,sass,scss,javascript,coffee,python,ruby,eruby,julia setl expandtab list
...
" Folding
au FileType html,htmldjango,css,sass,javascript,coffee,python,ruby,eruby,julia setl foldmethod=indent foldenable
